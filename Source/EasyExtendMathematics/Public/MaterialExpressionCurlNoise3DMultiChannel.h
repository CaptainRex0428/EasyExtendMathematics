...
#include "MaterialExpressionCurlNoise3DMultiChannel.generated.h"

UCLASS(MinimalAPI, collapsecategories, hidecategories = Object)
class UMaterialExpressionCurlNoise3DMultiChannel : public UMaterialExpression
{
...
public:
	...
	UMaterialExpressionCurlNoise3DMultiChannel(const FObjectInitializer& ObjectInitializer);
	...
	virtual FText GetKeywords() const override {return FText::FromString(TEXT("CurlNoise3DMultiChannel"));}
...
inline UObject* UMaterialExpressionCurlNoise3DMultiChannel::GetReferencedTexture() const
{
