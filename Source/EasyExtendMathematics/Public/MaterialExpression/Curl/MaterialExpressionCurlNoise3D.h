...
#include "MaterialExpressionCurlNoise3D.generated.h"

UCLASS(MinimalAPI, collapsecategories, hidecategories = Object)
class UMaterialExpressionCurlNoise3D : public UMaterialExpression
{
...
public:
	...
	UMaterialExpressionCurlNoise3D(const FObjectInitializer& ObjectInitializer);
	...
	virtual FText GetKeywords() const override {return FText::FromString(TEXT("CurlNoise3D"));}
...
inline UObject* UMaterialExpressionCurlNoise3D::GetReferencedTexture() const
{
